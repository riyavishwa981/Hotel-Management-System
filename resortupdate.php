...
$id=$_GET['id'];
$pricee = $_POST['price'];
$discounte = $_POST['discount'];
$contactn = $_POST['contactno'];
$emaili = $_POST['email'];

$qy = " UPDATE resortdetail SET id='$id', price='$pricee', discount='$discounte', contactno='$contactn', email='$emaili' where id='$id'";
...
<div class="col-lg-6 m-auto">
  <form  method="post" style="border: 5px solid #5a2360; padding-right: 10px;padding-left: 10px;">
    <div class="card">
      <div class="card-header" style="background-color: #5a2360;">
        <h3 class="text-white text-center">Updates Details of Resort/Villas</h3>
      </div>
    </div>
    <br>

    <label style="color: black; font-weight: bold; font-size: 18px;">PRICE PER DAY/PERSON: </label>
    ...
    <input type="EMAIL" name="email" placeholder="Enter valid email id" class="form-control" style="color: grey; border: 1px solid black;" not-required><br><br>
    <button class="btn" style="color:white; background-color: #5a2360; width: 500px; margin-left: 40px;" type="submit" 
    name="done">Update</button>
    <br>
    <br>
