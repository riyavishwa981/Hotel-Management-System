...
if(isset($_POST['submit'])){
      ...
      $email = $_GET['email'];
      $changepass=mysqli_query($connect,"update signup set password='".$npassword."',confirmpassword='".$cpassword."' where email='".$email."'");
      if($changepass){
...
<link rel="stylesheet" type="text/css" href="styles/responsive.css">
    ...
    <div class="login-box" style="margin-top: 400px;">
        ...
        <h3 style="color:white;" class="login here">Password Reset 
</h3>
            <form method="post">
            <BR><p>New Password</p>
            <input type="password" class="form-control" name="npassword" placeholder="Enter password" required="true">
            <BR><p>Confirm Password</p>
            <input type="password" class="form-control" name="cpassword" placeholder="Enter password" required="true">
