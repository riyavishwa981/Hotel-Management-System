...
$connect= mysqli_connect('localhost','root','','hotelhunt');
if(isset($_POST['submit'])){
      $email = $_POST['email'];
      $check_email=mysqli_query($connect,"select * from signup where email='".$email."'");
      if(mysqli_num_rows($check_email)!=0){
            header('location:resetp.php?email='.$email);
             
      }
      else{
      echo '<script type="text/javascript">';
	echo 'alert("wrong email");';
	echo 'window.location.href = "forgetadmin.php";';
	echo '</script>';
      }
                                    ...
                                    <div class="header_inner d-flex flex-row align-items-center justify-content-start">
                                          <nav class="main_nav">
                                                <ul class="d-flex flex-row align-items-center justify-content-start">
                                                      ...
                                                      <li  class="active"><a href="forgetadmin.php"><div class="nav_item d-flex flex-column align-items-center justify-content-center"><span>Admin</span></div></a></li>
                                                </ul>
                                          </nav>
...
<div class="login-box" style="margin-top: 5px; height: 380px; width: 380px; margin-bottom: 350px;">
            <h1 class="loginhere" style="margin-bottom: 10px;">Forget Password</h1>
                <form method="post">
                <p>Email</p>
                ...
                <br><br>
               <!-- <a href="loginadmin.html" style="font-size: 18px;">Go to login page</a>
--> 
                </form>
